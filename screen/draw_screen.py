...
import sys
import os
picdir = os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), 'waveshare/pic')
libdir = os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), 'waveshare/lib')
if os.path.exists(libdir):
    sys.path.append(libdir)

import logging
from waveshare.lib.waveshare_epd import epd2in9b_V3
import time
...
try:
    ...
    from sensors.net import Network
    net = Network()

    # drawblack.text((10, 0), 'IP:', font = font24, fill = 0)
    # drawry.text((40, 0), net.default_route(), font = font24, fill = 0)
    # drawblack.text((10, 0), 'hello world', font = font24, fill = 0)

    drawblack.text((30, 0), 'Hola Sandra', font = font24, fill = 0)
    drawry.text((35, 20), 'Te Amo', font = font24, fill = 0)
